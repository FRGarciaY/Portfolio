<section id="realisation"><!-- #realisation -->
    ...
    <div class="row" id="sitePortfolio"><!-- #sitePortfolio -->
        ...
        <div class="col-xs-12 col-sm-6 policeSpecial2 padding15">
            ...
            <p>Le site se charge, puis des instruction en jquery permettent de changer la mise en page si javascript est activé sur le navigateur.</p>
    ...
    <div class="row" id="plentycoups"><!-- #plentycoups -->
        ...
        <div class="col-xs-12 col-sm-6 policeSpecial2 padding15">
            ...
            <br>
            <p>Après avoir étudié le cahier des charges, nous en avons déduit les besoins de l'application. Nous avons donc modélisé la base de données, puis sous Symfony 3, créée les entités (objets). Nous avons ensuite réalisé le mapping, c'est à dire les relations entre les objets, puis grace à <a href="https://fr.wikipedia.org/wiki/Doctrine_(ORM)" title="Definition de Doctrine selon Wikipedia">Doctrine</a>, ORM par defaut de Symfony, nous avons généré la base de données MySQL correspondante.</p>
            <br>    
        ...
        <div class="col-xs-12 col-sm-6 policeSpecial2 padding15">
            ...
            <p>Nous avons utiliser Tortoise SVN pour gérer les différentes versions de notre code</p>
            <br>
    ...
    <div class="row" id="plentycoups"><!-- #GSB -->
        ...
        <div class="col-xs-12 policeSpecial2 padding15">
            ...
            <p>Les Tables MEDICAMENT, FAMILLE, OFFRIR, RAPPORT-VISITE, PRATICIEN sont concernés</p>
        </div>
        <div class="col-xs-12 col-sm-6 policeSpecial2 padding15">
    ...
    <div class="row" id="ApplicationCalculatrice"><!-- #ApplicationCalculatrice -->
        <div class="col-xs-12 col-sm-6 policeSpecial2 padding15">
            ...
            <p>Les fonctionnalitées sont celle d'une calculatrice standard.</p>
